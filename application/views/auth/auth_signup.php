            ...
            <footer>
                <div class="footer clearfix text-muted">
                    <div class="text-center">
                        <p>&copy; Copyright 2023 - <?= date("Y"); ?> <a href="https://github.com/cutieji" target="_blank"><?= getenv('APP_NAME'); ?></a>. All rights reserved.</p>
                    </div>
                    <div class="text-center">
                        <p>
                            Developed with <span class="text-danger"><i class="bi bi-heart-fill icon-mid"></i></span> By
                            <a href="https://github.com/cutieji" target="_blank">Rosh</a>
                        </p>
                    </div>
                </div>
            </footer>
